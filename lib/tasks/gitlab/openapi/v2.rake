...
YAML_V2_DOC_INTRODUCTION = <<-INTRO
#############################################################################################
    ...
    namespace :v2 do
      ...
      task check_docs: :environment do
        ...
        generated_doc = Digest::SHA512.hexdigest(
          YAML_V2_DOC_INTRODUCTION + Gitlab::Json.parse(File.read('tmp/openapi_swagger_doc.json')).to_yaml
        )
        ...
        if current_doc == generated_doc
          ...
          puts heading
          puts '#'
          puts '# OpenAPI documentation is outdated! Please update it by running `bin/rake gitlab:openapi:v2:generate`.'
          puts '#'
          puts heading
