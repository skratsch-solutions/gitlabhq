...
class CommitStatusPresenter < Gitlab::View::Presenter::Delegated
  CALLOUT_FAILURE_MESSAGES = {
    ...
    stuck_pending_with_matching_runners: 'The job was stuck in pending state with matching runners available. Check your job configuration or try again',
    stuck_pending_no_matching_runners: 'The job was stuck in pending state with no matching runners available. Check your runner tags or configuration',
    no_updates_running: 'The job was running but showed no activity for an extended period. Check your job script or try again',
    no_updates_canceling: 'The job was canceling but showed no activity for an extended period. Try again',
    server_timeout_running: 'The running job exceeded the maximum execution time set for the job',
    server_timeout_canceling: 'The canceling job exceeded the maximum execution time set for the job',
