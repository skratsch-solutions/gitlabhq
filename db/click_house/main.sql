...
CREATE TABLE siphon_p_ci_builds_metadata
(
    `project_id` Int64,
    `timeout` Nullable(Int64),
...
CREATE TABLE siphon_p_ci_builds_metadata_pg_pkey_ordered
(
    `id` Int64 CODEC(DoubleDelta, ZSTD(1)),
    `partition_id` Int64 CODEC(DoubleDelta, ZSTD(1)),
    `traversal_path` String DEFAULT '0/' CODEC(ZSTD(3)),
...
CREATE MATERIALIZED VIEW siphon_p_ci_builds_metadata_pg_pkey_ordered_mv TO siphon_p_ci_builds_metadata_pg_pkey_ordered
(
    `id` Int64,
    `partition_id` Int64,
    `traversal_path` String,
