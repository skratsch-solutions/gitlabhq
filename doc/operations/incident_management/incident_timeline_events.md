...
- [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/365489) in GitLab 15.3 [with a feature flag](../../administration/feature_flags/_index.md) named `incident_timeline_events_from_labels`. Disabled by default.
