...
> **Prerequisite:** Read `.ai/principles/distilled/qa-jest.md` first — it
...
See `.ai/principles/distilled/qa-jest.md` for the full how-to on all three
layers: unit/component tests, MSW integration tests, and Capybara feature
tests.

For MSW-specific additions not covered in `qa-jest.md` (run command, handler
registration pattern, GraphQL request counting), see
`.ai/principles/baselines/qa-msw.md`.
