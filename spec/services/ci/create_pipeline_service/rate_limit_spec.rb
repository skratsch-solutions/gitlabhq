...
RSpec.describe Ci::CreatePipelineService, :freeze_time,
  ...
  describe 'rate limiting' do
    ...
    shared_examples 'applies the scope per user' do
    ...
    describe 'pipelines_create limit' do
      before do
      ...
      it_behaves_like 'applies the scope per user'
    ...
    describe 'pipelines_per_user limit' do
      before do
        stub_ci_pipeline_yaml_file(gitlab_ci_yaml)
