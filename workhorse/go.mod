...
require (
	...
	gitlab.com/gitlab-org/quality/analytics/test-metrics-exporters/go v0.0.4 // indirect
...
tool gitlab.com/gitlab-org/quality/analytics/test-metrics-exporters/go/cmd/gitlab-test-metrics-exporter
